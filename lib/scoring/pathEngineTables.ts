...
export interface PathDefinition {
  ...
  compatibleTracks: string[]; // Track names or subfield names matching exact leaves or main groups
...
export const PATH_DATABASE: PathDefinition[] = [
  ...
  {
    id: 'hvac-mechanical-technician',
    title: 'تکنسین تأسیسات مکانیکی و سرمایش/گرمایش',
    category: 'صنعت و تأسیسات',
    description: 'محاسبه، نصب و عیب‌یابی سیستم‌های تهویه مطبوع، موتورخانه‌ها و سیستم‌های حرارتی و برودتی صنعتی.',
    gardnerWeights: { bodily: 0.85, logical: 0.6, spatial: 0.5 },
    compatibleTracks: ['تأسیسات مکانیکی', MainGroups.TVET_INDUSTRY],
    behavioralVector: { structure: 85, social: 30, autonomy: 60, pace: 55, analytical_vs_valuebased: 85, competitiveness: 45 },
    recommendedHighschoolTrack: 'فنی‌وحرفه‌ای (تأسیسات مکانیکی)',
    universityMajors: ['کاردانی و کارشناسی تأسیسات حرارتی و برودتی', 'مهندسی سیالات'],
    exampleCareers: ['تکنسین موتورخانه و تهویه مطبوع', 'پیمانکار سیستم‌های حرارتی برودتی', 'ناظر تأسیسات ساختمان'],
  },
  {
    id: 'chemical-materials-engineering',
    title: 'مهندسی شیمی، متالورژی و مواد نوظهور',
    category: 'صنعت و شیمی',
    description: 'تحلیل فرآیندهای شیمیایی، استخراج فلزات، ساخت آلیاژها و تولید مواد نانو و پلیمرها.',
    gardnerWeights: { logical: 0.85, naturalistic: 0.6, intrapersonal: 0.4 },
    compatibleTracks: ['متالورژی، معدن و صنایع شیمیایی', MainGroups.MATH_PHYSICS, MainGroups.EXPERIMENTAL_SCIENCE],
    behavioralVector: { structure: 85, social: 30, autonomy: 65, pace: 55, analytical_vs_valuebased: 90, competitiveness: 55 },
    recommendedHighschoolTrack: 'ریاضی‌فیزیک یا فنی‌وحرفه‌ای (صنایع شیمیایی / متالورژی)',
    universityMajors: ['مهندسی شیمی', 'مهندسی مواد و متالورژی', 'مهندسی پلیمر'],
    exampleCareers: ['مهندس کنترل فرآیند شیمیایی', 'متخصص متالورژی صنعتی', 'کارشناس آزمایشگاه پلیمر'],
  },
  {
    id: 'medicine',
  ...
  },
  {
    ...
    title: 'موسیقی، نوازندگی و آهنگسازی',
    category: 'هنرهای شنیداری',
    description: 'خلق ملودی، تنظیم قطعات موسیقی، نوازندگی تخصصی و تدوین سیستم‌های صوت و آکوستیک.',
    gardnerWeights: { musical: 0.95, intrapersonal: 0.6, bodily: 0.5 },
    compatibleTracks: [MainGroups.TVET_ARTS],
    behavioralVector: { structure: 30, social: 50, autonomy: 85, pace: 60, analytical_vs_valuebased: 25, competitiveness: 50 },
    recommendedHighschoolTrack: 'فنی‌وحرفه‌ای (گروه هنر)',
    universityMajors: ['نوازندگی موسیقی ایرانی و جهانی', 'آهنگسازی'],
    exampleCareers: ['آهنگساز و تنظیم‌کننده', 'نوازنده ارکستر', 'مدرس تخصصی موسیقی'],
  },
  {
    id: 'handicrafts-arts',
    title: 'صنایع دستی، معرق و هنرهای سنتی',
    category: 'هنر و صنایع دستی',
    description: 'خلق آثار هنری اصیل با چوب، فلز و سرامیک، معرق‌کاری، منبت و حفظ میراث هنری.',
    gardnerWeights: { spatial: 0.8, bodily: 0.8, intrapersonal: 0.5 },
    compatibleTracks: ['صنایع دستی و عکاسی', MainGroups.TVET_ARTS],
    behavioralVector: { structure: 60, social: 25, autonomy: 80, pace: 35, analytical_vs_valuebased: 30, competitiveness: 30 },
    recommendedHighschoolTrack: 'فنی‌وحرفه‌ای (صنایع دستی و عکاسی)',
    universityMajors: ['صنایع دستی', 'مرمت آثار تاریخی'],
    exampleCareers: ['استادکار صنایع دستی', 'مرمت‌کار اشیای تاریخی', 'مدیر کارگاه هنرهای سنتی'],
  },
  {
    id: 'civil-surveying',
    title: 'نقشه‌برداری و مهندسی ژئوماتیک',
    category: 'مهندسی و عمران',
    description: 'اندازه‌گیری و ثبت عوارض زمین، تهیه نقشه‌های توپوگرافی و پهپادبرداری پروژه‌های ملی.',
    gardnerWeights: { spatial: 0.85, logical: 0.8, bodily: 0.5 },
    compatibleTracks: ['نقشه‌کشی معماری و ساختمان', MainGroups.MATH_PHYSICS],
    behavioralVector: { structure: 85, social: 35, autonomy: 65, pace: 60, analytical_vs_valuebased: 90, competitiveness: 50 },
    recommendedHighschoolTrack: 'ریاضی‌فیزیک یا فنی‌وحرفه‌ای (نقشه‌کشی معماری و ساختمان)',
    universityMajors: ['مهندسی نقشه‌برداری', 'ژئودزی و سنجش از دور'],
    exampleCareers: ['مهندس نقشه‌بردار', 'متخصص پردازش تصاویر پهپادی', 'کارشناس سامانه اطلاعات مکانی (GIS)'],
  },
  {
    id: 'mining-geology',
    title: 'مهندسی معدن و زمین‌شناسی کاربردی',
    category: 'مهندسی و منابع طبیعی',
    description: 'کشف، استخراج ذخایر معدنی و پیجویی منابع زیرزمینی کشور با ابزارهای مهندسی.',
    gardnerWeights: { naturalistic: 0.8, logical: 0.75, bodily: 0.6 },
    compatibleTracks: ['متالورژی، معدن و صنایع شیمیایی', MainGroups.MATH_PHYSICS, MainGroups.EXPERIMENTAL_SCIENCE],
    behavioralVector: { structure: 80, social: 35, autonomy: 70, pace: 55, analytical_vs_valuebased: 90, competitiveness: 55 },
    recommendedHighschoolTrack: 'ریاضی‌فیزیک یا فنی‌وحرفه‌ای (متالورژی و معدن)',
    universityMajors: ['مهندسی معدن (اکتشاف، استخراج)', 'زمین‌شناسی'],
    exampleCareers: ['مهندس اکتشاف معدن', 'ناظر استخراج معادن', 'کارشناس زمین‌شناسی صنعتی'],
  },
  {
    id: 'primary-special-education',
    title: 'علوم تربیتی و آموزش کودکان استثنایی',
    category: 'آموزش و توان‌بخشی',
    description: 'آموزش صبورانه، توان‌بخشی شناختی و هدایت تربیتی کودکان در مراحل ابتدایی و رشد.',
    gardnerWeights: { interpersonal: 0.95, intrapersonal: 0.6, bodily: 0.4 },
    compatibleTracks: [MainGroups.HUMANITIES, MainGroups.EXPERIMENTAL_SCIENCE],
    behavioralVector: { structure: 75, social: 95, autonomy: 40, pace: 35, analytical_vs_valuebased: 20, competitiveness: 15 },
    recommendedHighschoolTrack: 'ادبیات و علوم‌انسانی یا علوم تجربی',
    universityMajors: ['آموزش کودکان استثنایی', 'روان‌شناسی تربیتی'],
    exampleCareers: ['معلم کودکان استثنایی', 'مربی توان‌بخشی شناختی', 'مشاور رشد کودک'],
  },
  {
    id: 'industrial-metals-technician',
    title: 'صنایع فلزی و جوشکاری صنعتی پیشرفته',
    category: 'صنعت و تولید',
    description: 'ساخت سازه‌های فلزی سنگین، جوشکاری تخصصی خطوط لوله و بازرسی فنی اتصالات.',
    gardnerWeights: { bodily: 0.85, spatial: 0.6, logical: 0.5 },
    compatibleTracks: ['صنایع فلزی', MainGroups.TVET_INDUSTRY],
    behavioralVector: { structure: 80, social: 25, autonomy: 55, pace: 55, analytical_vs_valuebased: 85, competitiveness: 45 },
    recommendedHighschoolTrack: 'فنی‌وحرفه‌ای (صنایع فلزی)',
    universityMajors: ['کاردانی و کارشناسی جوشکاری صنعتی', 'صنایع فلزی'],
    exampleCareers: ['بازرس فنی جوش', 'سرپرست صنایع فلزی سنگین', 'تکنسین جوشکاری خطوط لوله'],
  },
];
